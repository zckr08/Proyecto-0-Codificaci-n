def main():
    ...
    continuar = input("¿Desea usar el programa? 1 = Continuar  2 = Terminar: ")
    ...
    while continuar == "1":
        ...
        print("6. Escítala")
        seleccion = input("Para seleccionar elige el número del cifrado (1 a 6): ")
        while seleccion not in ("1", "2", "3", "4", "5", "6"):
            seleccion = input("La selección debe ser un número entre 1 y 6, intente de nuevo: ")
        seleccion = int(seleccion)
        seleccion2 = input("Eliga 1 para Codificar o 2 para Decodificar: ")
        while seleccion2 not in ("1", "2"):
            seleccion2 = input("La selección debe ser 1 para codificar o 2 para decodificar, intente de nuevo: ")
        ...
        if seleccion == 1:
            ...
            if seleccion2 == 1:
                textoCod = cesarCod(texto, desplazamiento)
                print("El texto codificado con cifrado César es: " + textoCod)
            elif seleccion2 == 2:
                textoDec = cesarDec(texto, desplazamiento)
