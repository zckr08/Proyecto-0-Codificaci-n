...
def main():
    ...
    while continuar == "1":
        try:
            ...
            seleccionOpcion = input("Eliga 1 para Codificar o 2 para Decodificar: ")
            while seleccionOpcion not in ("1", "2"):
                seleccionOpcion = input("La selección debe ser 1 para codificar o 2 para decodificar, intente de nuevo: ")
            seleccionOpcion = int(seleccionOpcion)
            ...
            if seleccionMetodo == 1:
                ...
                if seleccionOpcion == 1:
                    ...
                    texto = str(input("Digite el texto que quiere decodificar: "))
                V = input("Digite la cantidad de letras por vuelta: ")
                while not V.isdigit() or int(V) < 1:
                    V = input("El número no es válido, intente de nuevo: ")
                V = int(V)
                if seleccionOpcion == 1:
